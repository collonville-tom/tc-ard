/*
  T
  his is a demo of ESP8266 WiFi Module in standalone mode (without Arduino) controlling an LED via a Web page.
...
const char* SSID = "Freebox-397104";
const char* password = "remittam2-fraxineas-convivat9-fessus&4";
